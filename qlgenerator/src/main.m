...
#define PLUGIN_ID "9BA5EA28-4173-40E8-B6A3-FF218B051F4E"
...
QuickLookGeneratorPluginType* AllocQuickLookGeneratorPluginType(CFUUIDRef inFactoryID)
{
	...
	[file_manager createDirectoryAtPath:@"/tmp/qlmoviepreview/" withIntermediateDirectories:YES attributes:nil error:nil];
